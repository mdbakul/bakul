...
// bakul_product_sidebar_filter before
function bakul_product_sidebar_before($output){
   $output = '<div class="tp-shop-widget-product">';

   return $output;
}
add_filter('woocommerce_before_widget_product_list','bakul_product_sidebar_before');
// bakul_product_sidebar_filter after
function bakul_product_sidebar_after($output){
   $output = '</div>';

   return $output;
}
add_filter('woocommerce_after_widget_product_list','bakul_product_sidebar_after');
...
// bakul_product_details
function bakul_product_details(){
   global $product;
   global $post;
   global $woocommerce;
   ...
   ?>
      <div class="tp-shop-details__right-warp mt-0">
            ...
            <div class="tp-shop-details__price">
               ...
               <span class="red-color"><?php echo bakul_sale_percentage(); ?></span>
            </div>
            ...
            <div class="product__details-share">
               <?php do_action('bakul_woo_social_share'); ?>
            </div>
      </div>
   <?php
}

add_action('woocommerce_single_product_summary','bakul_product_details');




// product add to cart button
function bakul_wooc_add_to_cart( $args = array() ) {
    global $product;
...
add_action( 'wp_footer' , 'bakul_custom_quantity_fields_script' );

// custom_quantity_fields_script
function bakul_custom_quantity_fields_script(){
    ?>
