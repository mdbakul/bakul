...
<div class="product_meta">
	...
	<div class="product__details-categories product__details-more mb-15">
		<p><?php echo esc_html(_n( 'Category:', 'Categories:', count( $product->get_category_ids() ), 'woocommerce' )); ?></p>
		<?php 
        $html = '';
	...
	<div class="product__details-tags mb-15">
		<span><?php echo esc_html(_n( 'Tag:', 'Tags:', count( $product->get_tag_ids() ), 'woocommerce' )); ?></span>
		<?php 
        $html = '';
