<?php 
   ...
   // Phone Number
   $header_top_phone = get_theme_mod( 'header_phone', __( '+99 (786) 8765', 'bakul' ) );
   ...
   // button
   $header_button_text = get_theme_mod( 'header_button_text', __( 'MAKE APPOINMENT', 'bakul' ) );
   $header_button_link = get_theme_mod( 'header_button_link', __( '#', 'bakul' ) );
                       ...
                       <div class="tp-header-right-tel-box d-none d-xxl-block">
                          <div class="tp-header-right-tel-icon d-flex align-items-center">
                             ...
                             <div class="tp-header-right-tel-content">
                                <span><?php echo esc_html('Talk to an expert','bakul'); ?> </span>
                                <a href="tel:<?php echo esc_html($phone_number_url); ?>"><span><?php echo esc_html('Free','bakul'); ?></span> <?php echo esc_html($header_top_phone); ?></a>
                             </div>
                          </div>
                       </div>
                       <?php endif; ?>
