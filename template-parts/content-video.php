 ...
 */
 ...
 $bakul_video_url = function_exists('tpmeta_field')? tpmeta_field('bakul_post_video') : '';
...
<article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item transition-3 format-video' );?>>
  <?php if(has_post_thumbnail()) : ?>  
      <div class="postbox__thumb">
         ...
         <?php if(!empty($bakul_video_url)) : ?>
         <div class="postbox__play-btn">
               <a class="popup-video pulse-btn"
                  href="<?php echo esc_url($bakul_video_url); ?>"><i class="fa-light fa-play"></i></a>
         </div>
         <?php endif; ?>
