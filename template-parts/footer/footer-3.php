...
*/
    ...
    $bakul_footer_logo = get_theme_mod( 'bakul_footer_logo' );
    $bakul_footer_top_space = function_exists('tpmeta_field') ? tpmeta_field('bakul_footer_top_space') : '0';
    $bakul_copyright_center = $bakul_footer_logo ? 'col-lg-4 offset-lg-4 col-md-6 text-right' : 'col-lg-12 text-center';
    $bakul_footer_bg_url_from_page = function_exists( 'tpmeta_image_field' ) ? tpmeta_image_field( 'bakul_footer_bg_image' ) : '';
    $bakul_footer_bg_color_from_page = function_exists( 'tpmeta_field' ) ? tpmeta_field( 'bakul_footer_bg_color' ) : '';
    ...
    // bg image
    $bg_img = !empty( $bakul_footer_bg_url_from_page['url'] ) ? $bakul_footer_bg_url_from_page['url'] : $footer_bg_img;

    // bg color
    $bg_color = !empty( $bakul_footer_bg_color_from_page ) ? $bakul_footer_bg_color_from_page : $footer_bg_color;
    ...
    Newsletter', 'bakul' ) );
    $footer_top_cta = get_theme_mod( 'footer_top_cta', __( 'do shortcode', 'bakul' ) );
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="tp-footer-subscribe-wrapper-title d-flex align-items-center">
                            ...
                            <h3 class="tp-footer-subscribe-title"> <?php echo bakul_kses( $footer_top_cta_title ); ?></h3>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-footer-copyright-inner">
                        <p><?php print bakul_copyright_text(); ?></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
