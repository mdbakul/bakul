...
if (comments_open()) :
    ...
    <div id="comments" class="comments-area">
        ...
        $fields = array(
            'author' => '<div class="row"><div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6"><div  class="tp-contact-form-input-box"><input type="text" name="author" id="author" placeholder="' . esc_attr__('Name*', 'harry') . '" value="' . esc_attr($commenter['comment_author']) . '" ' . ($req ? 'required' : '') . '></div>
         </div>',
